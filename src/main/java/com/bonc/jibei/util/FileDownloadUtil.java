 ...
 * @author ：wjx.
 * @version ：
 * @date ：Created at 18:33 2022/4/24
 */
@Component
public class FileDownloadUtil {
     ...
     * 把文件打成压缩包并输出到客户端浏览器中
     */
    public void downloadZipFiles(HttpServletResponse response, List<String> srcFiles) {
        try {
            String zipFileName = LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMddHHmmssSSSSSS")) + ".zip";
            response.reset(); // 重点突出
